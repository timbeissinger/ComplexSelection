---
title: "Do Mapping on 1000-QTL Complex Selection Simulations"
...
directory = "/home/beissingert/data/PolySelect_bigsims/QTL_1000_big/r_qtl_1000" #this is for running on ircf
...
```{r}
positions <- seq(0.5,99.5,length.out=100)*100+ c(rep(0,100),rep(10000,100),rep(20000,100),rep(30000,100),rep(40000,100),rep(50000,100),rep(60000,100),rep(70000,100),rep(80000,100),rep(90000,100))
