---
title: "Analysis of 50-QTL simulated datasets to test for polygenic selection"
...
for(sim in 1:100){
	...
	directory="/home/beissingert/data/PolySelect_bigsims/QTL_50_big/r_qtl_50"
	...
	# Record LD value
	R2[sim] <- as.numeric(substr(readLines(paste("../../QTL_50_big/r_qtl_50/DriftPop_ld_decay_",iter,".txt",sep=""))[44],10,15))
}
```
