---
title: "Analysis of 1000-QTL simulated datasets to test for polygenic selection"
...
for(sim in 1:100){
	...
	# Record LD value
	R2[sim] <- as.numeric(substr(readLines(paste("../../QTL_1000_big/r_qtl_1000/DriftPop_ld_decay_",iter,".txt",sep=""))[44],10,15))
}
```
